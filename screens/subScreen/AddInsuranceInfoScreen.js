...
export default class AddInsuranceInfoScreen extends React.Component {
    ...
    componentDidMount() {
        ...
        this.focusListener = navigation.addListener('didFocus', () => {
            ...
            this.setState({
                buyers_id: '', ins_company: '', ins_pol_num: '', ins_phone: '', ins_address: '', ins_city: '', ins_state: '', ins_zip: '', ins_agent: '',
                error_buyers_id: false, error_ins_company: false, error_ins_pol_num: false, error_ins_phone: false, error_ins_address: false, error_ins_city: false, error_ins_state: false, error_ins_zip: false, error_ins_agent: false
            })
    ...
    async addInsuranceInfo() {
        ...
        } else if (this.state.ins_company == "") {
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={AppStyles.header_title_screen}>Add Insurance Info</Text>
                ...
                <TouchableOpacity style={AppStyles.button} activeOpacity={.5} onPress={() => this.addInsuranceInfo()}>
                    <Text style={AppStyles.buttonText}> Add Insurance Info </Text>
                </TouchableOpacity>
